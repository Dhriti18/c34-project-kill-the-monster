...
function setup() {
  ...
  hero = new Hero(100,345,250);
  rope = new Rope(hero.body, { x: 300, y: 50 });
  monster = new Monster(1100,550,300);

  box1 = new Box(900, 100, 70, 70);
  box2 = new Box(900, 120, 70, 70);
  box3 = new Box(900, 130, 70, 70);
  box4 = new Box(900, 150, 70, 70);
  box5 = new Box(900, 150, 70, 70);
  box6 = new Box(900, 170, 70, 70);
  ...
  box16= new Box(700, 130, 70, 70);
  box17 = new Box(800, 110, 70, 70);
  box18= new Box(800, 120, 70, 70);
  box19= new Box(700, 130, 70, 70);
